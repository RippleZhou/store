...
// let cUrl = 'https://v.3721zh.com/api/'   //正式
// var cUrl='https://jpaytest.3721zh.com/'
var cUrl='https://japitest.3721zh.com/webapp/'  //本地
...
const api = {
  ...
  customer: {
    userRegister1:cUrl+'customer/userRegister1',
    ...
    checkWxIsLogin: cUrl + 'customer/checkH5IsLogin',
  ...
  borrow: {
    bwConverBean:cUrl+'borrow/bwConverBean',
  ...
  userEnvelope: {
    ...
    takeActivityEnv:cUrl +'cusEnvelope/takeActivityEnv' 
  },
  shops: {
  ...
  selectUserBean: cUrl + 'cusConverBeanItem/selectUserBean',
  ...
  getMiniAppOpenId: cUrl+'customer/getMiniAppOpenId',
  addMiniOpenId: cUrl+'customer/addMiniOpenId'
